...
ChatGPT<WiFiClientSecure> chat_gpt(&client, "v1", "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");   // Please fill in your OpenAI key
...
bool uploadFile(){
  ...
  HTTPClient client;
  client.begin("http://172.168.1.170:8888/uploadAudio");
